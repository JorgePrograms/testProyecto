...
class DetallePedidoJpaRepositoryAdapterTest {
    ...
    void findById() {
        ...
        ProductoEntity productoEntity=new ProductoEntity(3L, 155.154, "mouse", 20, new HashSet<>());
        ...
        Producto producto = new Producto(3L, 155.154, "mouse", 20, new HashSet<>());
    ...
    void findAll() {
        ...
        Producto producto1 = new Producto(1L, 155.154, "mouse", 20, new HashSet<>());
        ...
        Producto producto2 = new Producto(2L, 299.99, "keyboard", 15, new HashSet<>());
        ...
        ProductoEntity productoEntity1 = new ProductoEntity(1L, 155.154, "mouse", 20, new HashSet<>());
        ...
        ProductoEntity productoEntity2 = new ProductoEntity(2L, 299.99, "keyboard", 15, new HashSet<>());
