...
class ProductoJpaRepositoryAdapterTest {
    ...
    @Test
    void save() {
        Producto producto=new Producto(1L,155.154,"mouse",20,new HashSet<>());

        ProductoEntity productoEntity=new ProductoEntity(1L,155.154,"mouse",20,new HashSet<>());
    ...
    @Test
    void saveExistente(){
        Producto productoExistente=new Producto(1L,155.154,"mouse",20,new HashSet<>());
    ...
    void findById() {
        Long id = 1L;
        ProductoEntity productoEntity = new ProductoEntity(id, 156.23,"teclado", 100,new HashSet<>());
        Producto producto=new Producto(id, 156.23,"teclado", 100,new HashSet<>());
    ...
    @Test
    void getAllProducto() {
        Producto producto1 = new Producto(1L, 156.23, "teclado", 100, new HashSet<>());
        Producto producto2 = new Producto(2L, 299.99, "mouse", 50, new HashSet<>());
        List<Producto> productos = Arrays.asList(producto1, producto2);

        ProductoEntity productoEntity1 = new ProductoEntity(1L, 156.23, "teclado", 100, new HashSet<>());
        ProductoEntity productoEntity2 = new ProductoEntity(2L, 299.99, "mouse", 50, new HashSet<>());
    ...
    void updateProductoExitoso() {
        Long id = 1L;
        Producto productoActualizado = new Producto(id, 156.23, "teclado actualizado", 100, new HashSet<>());


        when(productoJpaRepository.existsById(id)).thenReturn(true);

        ProductoEntity productoEntityActualizado = new ProductoEntity(id, 156.23, "teclado actualizado", 100, new HashSet<>());
