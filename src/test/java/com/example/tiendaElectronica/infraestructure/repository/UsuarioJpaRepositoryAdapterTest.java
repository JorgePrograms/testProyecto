...
class UsuarioJpaRepositoryAdapterTest {
    ...
    void save() {
        ...
        Usuario usuario=new Usuario(2L,"johndoe123","contraseña1","carlos543@gmail.com",cliente);
        UsuarioEntity usuarioEntity=new UsuarioEntity(2L,"johndoe123","contraseña1","carlos543@gmail.com",clienteEntity);
    ...
    void findByIdExitososUsuarioEntity() {
        Cliente cliente=new Cliente(2L,"Juan","Sanchez","masculino",new Date(),"977785431");
        Long id=2L;
                Usuario usuario=new Usuario(id,"johndoe123","contraseña1","carlos543@gmail.com",cliente);
        ClienteEntity clienteEntity=new ClienteEntity(2L,"Juan","Sanchez","masculino",new Date(),"977785431");
        UsuarioEntity usuarioEntity=new UsuarioEntity(id,"johndoe123","contraseña1","carlos543@gmail.com",clienteEntity);
    ...
    void findAll() {
        ...
        Usuario usuario1=new Usuario(2L,"johndoe123","contraseña1","carlos543@gmail.com",cliente1);
        Cliente cliente2=new Cliente(3L,"Tatiana","Palacios","femenino",new Date(),"988231454");
        Usuario usuario2 = new Usuario(3L, "janedoe456", "contraseña2", "tatiana123@gmail.com", cliente2);
        List<Usuario> usuarios= Arrays.asList(usuario1,usuario2);


        ClienteEntity clienteEntity1 = new ClienteEntity(2L, "Juan", "Sanchez", "masculino", new Date(), "977785431");
        UsuarioEntity usuarioEntity1 = new UsuarioEntity(2L, "johndoe123", "contraseña1", "carlos543@gmail.com", clienteEntity1);
        ClienteEntity clienteEntity2 = new ClienteEntity(3L, "Tatiana", "Palacios", "femenino", new Date(), "988231454");
        UsuarioEntity usuarioEntity2 = new UsuarioEntity(3L, "janedoe456", "contraseña2", "tatiana123@gmail.com", clienteEntity2);
